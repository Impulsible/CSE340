    ...
    const mockData = {
      2: [ // Sport - IDs: 1, 2, 6, 7
        ...
        { 
          ...
          inv_year: 2020, 
          inv_price: 32000,
          inv_image: "/images/vehicles/mustang-tn.jpg",
          inv_thumbnail: "/images/vehicles/mustang-tn.jpg",
          classification_id: 2
        },
        { 
          inv_id: 6, 
          inv_make: "Ford", 
          inv_model: "Model T Touring", 
          inv_year: 1919, 
          inv_price: 24500,
        ...
        { 
          ...
          inv_year: 2023, 
          inv_price: 507000,
          inv_image: "/images/vehicles/adventador-tn.jpg",
      ...
      4: [ // Truck - IDs: 13, 14, 15
        ...
        { 
          ...
          inv_year: 2021, 
          inv_price: 250000,
          inv_image: "/images/vehicles/monster-truck-tn.jpg",
  ...
  getVehicleDetailById: async (inv_id) => {
    ...
    const mockVehicles = {
      ...
      2: { 
        ...
        inv_image: "/images/vehicles/mustang.jpg",
        inv_thumbnail: "/images/vehicles/mustang-tn.jpg",
        inv_color: "Yellow",
        inv_miles: 8500
      },
